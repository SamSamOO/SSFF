...
public class StudyInsController {
   ...
   * 매개변수: boardId: 게시판ID, nickName: 닉네임
   * 반환: 내 특정 스터디 게시판 뷰단
   * */
  @GetMapping("/board/list")
  public String studyBoardList(String boardId, String nickName){
    log.info("studyBoardList({}) is invoked","boardId = " + boardId + ", nickName = " + nickName);
